---
title: Books
description: Published books by Enrico Piovesan on software architecture, WASM, and AI-native systems.
layout: books.njk
...
books:
  ...
  - title: "The Day After: How to Restructure Your Software Company for the Age of AI Agents"
    ...
    description:
      ...
      - The fix is not a rewrite. It is a deliberate process of making software organizations legible to AI agents without throwing everything away. Role by role, capability by capability. The architect declares the reasoning space before the sprint begins. The developer owns a contract, not just a ticket. The PM asks in discovery what a story format was never designed to hold.
