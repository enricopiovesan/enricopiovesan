...
Two books on software architecture. One published, one forthcoming. Both came from the same place: years of watching the same problems show up in different companies, different stacks, and different teams, and deciding that the answer was architectural, not incidental.
...
**Who it is for:** Software architects, senior engineers, and technical leads designing modern distributed systems who are tired of paying the hidden tax of duplicated logic across runtimes.

[Buy on Amazon](https://www.amazon.com/dp/B0GTTTTQH4) · [Companion repo](https://github.com/enricopiovesan/UMA-code-examples) · [Live reference app](https://www.universalmicroservices.com)
...
**Who it is for:** Engineering leaders, CTOs, staff architects, and senior developers who are watching AI agents become part of their teams and want a structured answer to the question of what needs to change and in what order.

[Companion tool](https://github.com/enricopiovesan/the-day-after-toolkit) · [C-DAD White Paper](/whitepapers/)
