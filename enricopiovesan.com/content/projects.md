...
[Repo](https://github.com/enricopiovesan/Traverse)

---

## youaskm3

**Personal knowledge layer · Rust, WASM, Web Components, PWA · In progress (M0)**

A personal knowledge layer built on the same foundations as Traverse and UMA. WASM-native, MCP-powered, designed to work with agentic systems. Runs entirely on GitHub Pages with no server, no database, and no ongoing cost. The federation model means anyone can fork it, run their own instance, and register in a shared registry. It is an attempt to build something that reflects what I actually believe about software: portable, composable, owned by the person running it, and free to operate.

[Repo](https://github.com/youaskm3/youaskm3) · [Site](https://youaskm3.com)
