...
**The Day After AI.** Contract signed with Apress, manuscript complete, forthcoming. The companion CLI tool (cdad) is built and in progress. Full book site live at [thedayafteraibook.com](https://thedayafteraibook.com).
...
**Traverse.** A contract-driven Rust and WASM runtime for portable business capabilities. Live at v0.8.1, open source, at [traverse-framework.com](https://traverse-framework.com).
