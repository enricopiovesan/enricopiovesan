...
*New perspectives are added as the field moves. The frameworks and concepts on this site, <abbr title="Universal Microservices Architecture">UMA</abbr> and <abbr title="Contract-Driven AI Development">C-DAD</abbr>, are the primary lens. Each perspective connects to one or both.*
